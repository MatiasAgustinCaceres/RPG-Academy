...
export const armasStore = [
  new Arma("Anillo Mágico", 0, 0, 20, 0, 0, [], 40, 1, "Assets/armas-store/anillo-magico.png"),
  ...
  new Arma("Escudo de acero", 25, 10, 0, 0, 0, [], 70, 1, "Assets/armas-store/escudo-de-acero.png"),
  new Arma("Espada de Cristal", 0, 20, 15, 0, 0, ["La mágia que recubre esta espada la hace tan resistente como el acero y las heridas causadas por esta espada no puden curarse con medicina convencional."], 90, 1, "Assets/armas-store/espada-de-cristal.png"),
  new Arma("Espadas duales", 0, 0, 0, 35, 0, [], 70, 1, "Assets/armas-store/espadas-duales.png"),
  new Arma("Katana", 0, 15, 0, 35, 0, [], 100, 1, "Assets/armas-store/katana.png"),
  new Arma("Lanza Xiaolin", 0, 0, 0, 35, 0, [], 70, 1, "Assets/armas-store/lanza-xiaolin.png"),
  new Arma("Mandoble de acero", 0, 50, 0, 0, 0, [], 1, 100, "Assets/armas-store/mandoble.png"),
  ...
  new Arma("Pergamino Antiguo", 0, 35, 0, 0, 0, [], 70, 1, "Assets/armas-store/pergamino-antiguo.png"),
  ...
  new Arma("Cuerno de Gondor", 50, 20, 0, 0, 0, ["Al utilizarse, le otroga +10 de fuerza, +10 de inteligencia y +10 de destreza a los aliados cercanos por un pequeño periodo de tiempo. "], 180, 1, "Assets/armas-lotr1/bara-de-mago.png"),
  ...
  new Arma("Pan de Lembas", 0, 0, 0, 0, 0, ["Al consumirlo, el usuario gana +5 de cada estadistica."], 50, 10, "Assets/armas-lotr1/anduril.png"),
  new Arma("Anillo único", 50, 50, 100, 50, 0, ["Todas lTodas las capacidades del usuario se verán incrementadas. El usuario podrá entrar al mundo inmaterial si se lo pone, El usuario podrá controlar a los demás usuarios de los anillos de poder. El usuario poco a poco será corrompido y consumido por la locura."], 500, 1, "Assets/armas-lotr1/anillo-unico.png"),
  new Arma("Narya", 50, 70, 0, 0, 30, ["El Anillo del Fuego. Fue creado para inspirar coraje y esperanza, y otorgar valor a quienes lo portaban para resistir la opresión y la desesperación."], 300, 1, "Assets/armas-lotr1/narya.png"),
  new Arma("Nenya", 50, 0, 0, 70, 30, ["El Anillo del Agua. Sus poderes residen en la preservación, la protección y la ocultación del mal"], 300, 1, "Assets/armas-lotr1/nenya.png"),
  new Arma("Vilya", 50, 0, 70, 0, 30, ["El Anillo del Agua. Sus poderes residen la curación y preservación, la capacidad de resguardar y rejuvenecer un lugar, y se especula que poseía control sobre ciertos elementos"], 300, 1, "Assets/armas-lotr1/vilya.png"),
];

/*export const armasLotr1 = [
  new Arma("Anduril", 20, 70, 0, 0, 0, [], 180, 1, "Assets/armas-lotr1/anduril.png"),
  new Arma("Arco de los Galadhrim", 10, 0, 0, 80, 0, [], 180, 1, "Assets/armas-lotr1/arco-galadhrim.png"),
  new Arma("Bara de Mago", 15, 0, 75, 0, 0, [], 180, 1, "Assets/armas-lotr1/bara-de-mago.png"),
  new Arma("Cuerno de Gondor", 50, 20, 0, 0, 0, ["Al utilizarse, le otroga +10 de fuerza, +10 de inteligencia y +10 de destreza a los aliados cercanos por un pequeño periodo de tiempo. "], 180, 1, "Assets/armas-lotr1/bara-de-mago.png"),
